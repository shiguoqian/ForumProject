...
<div class="fly-header layui-bg-black">
  <div class="layui-container">
    ...
    <ul class="layui-nav fly-nav-user">
      ...
      <!-- 这里href要调到个人主页 -->
      <li class="layui-nav-item">
        <a href="front/html/user/home.html">${sessionScope.user.uName}</a>
      </li>
...
<div class="fly-panel fly-column">
  <div class="layui-container">
    ...
    <div class="fly-column-right layui-hide-xs"> 
      ...
      <a href="front/html/jie/add.jsp" class="layui-btn">发表新帖</a> 
    </div> 
	...
	$.ajax({
		...
		success:function(result){
			...
			$(result).each(function(index,element){
				liStr="<a class='jie-title' + href='../jie/detail.htm'+ target='_blank'>"+element.pTitle+"</a>"+"<br/>"+"<i>"+element.pTime+"</i>"+"<br/>";
				html=html+liStr;
			});
			$("#collectCount").html($(result).length);
			var ulStr="<li>"+html+"</li>"
			
			//把拼接后的代码，追加到div
			$("#collect").append(ulStr);
