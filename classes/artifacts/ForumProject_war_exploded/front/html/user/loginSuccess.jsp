  ...
  <div class="layui-container">
    ...
    <ul class="layui-nav fly-nav-user">
      ...
      <li class="layui-nav-item">
        <a href="/servlet">${sessionScope.user.uName}</a>
      </li>
...
<div class="fly-panel fly-column">
  <div class="layui-container">
    <ul class="layui-clear">
      <li class="layui-hide-xs layui-this"><a href="/ForumProject/front/html/jie/shouye.jsp">首页</a></li> 
...
<script type="text/javascript" src="front/res/js/jquery-1.12.4.js"></script>
