...
!function (t) {
    if ("object" == typeof exports && "undefined" != typeof module) module.exports = t(); else if ("function" == typeof define && define.amd) define([], t); else {
        var e;
        e = "undefisned" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this, e.OSS = t()
    }
}(function () {
    var t;
    return function () {
        ...
        2: [function (t, e, r) {
            (function (r, n) {
                ...
                function s(t, e, r) {
                    var n = r ? "https://" : "http://", i = e ? "-internal.aliyuncs.com" : ".aliyuncs.com";
                    return "vpc100-oss-cn-" === t.substr(0, "vpc100-oss-cn-".length) && (i = ".aliyuncs.com"), T.parse(n + t + i)
                }
                ...
                function u(t, e) {
                    ...
                    t && t.inited ? this.options = t : this.options = u.initOptions(t), this.options.cancelFlag = !1, this.options.urllib ? this.urllib = this.options.urllib : (this.urllib = A, this.agent = this.options.agent || P), this.ctx = e, this.userAgent = this._getUserAgent(), this.options.amendTimeSkewed = 0
                }

                var l = t("babel-runtime/core-js/promise"), p = i(l), f = t("babel-runtime/regenerator"), d = i(f),
                    h = t("babel-runtime/core-js/object/keys"), m = i(h), v = t("debug")("ali-oss"),
                    b = t("./../../shims/crypto/crypto.js"), y = t("path"), g = t("copy-to"), _ = t("mime"),
                    w = t("xml2js"), x = t("humanize-ms"), E = t("agentkeepalive"), S = t("merge-descriptors"),
                    T = t("url"), k = t("is-type-of"), j = t("platform"), O = t("utility"), A = t("urllib"),
                    N = t("./version"), C = t("dateformat"), M = t("bowser"), I = t("../common/signUtils"),
                    L = t("../common/utils"), P = new E;
                e.exports = u, u.initOptions = function (t) {
                    ...
                    if ((0, m.default)(t).forEach(function (e) {
                        void 0 !== t[e] && (r[e] = t[e])
                    }), r.accessKeyId = r.accessKeyId.trim(), r.accessKeySecret = r.accessKeySecret.trim(), r.timeout && (r.timeout = x(r.timeout)), r.endpoint) r.endpoint = a(r.endpoint, r.secure); else {
                ...
                var D = u.prototype;
                D.debug = v, S(D, t("./object")), S(D, t("./managed-upload")), S(D, t("../common/multipart")), S(D, t("../common/parallel")), D.signature = function (t) {
                    return this.debug("authorization stringToSign: %s", t, "info"), I.computeSignature(this.options.accessKeySecret, t)
                }, D.authorization = function (t, e, r, n) {
                    var i = I.buildCanonicalString(t.toUpperCase(), e, {headers: n, parameters: r});
                    return I.authorization(this.options.accessKeyId, this.options.accessKeySecret, i)
                }, D.createRequest = function (t) {
                    var e = {
                        "x-oss-date": C(+new Date + this.options.amendTimeSkewed, "UTC:ddd, dd mmm yyyy HH:MM:ss 'GMT'"),
                        "x-oss-user-agent": this.userAgent
                    };
                    this.options.stsToken && (e["x-oss-security-token"] = this.options.stsToken), g(t.headers).to(e), o(e, "Content-Type") || (t.mime === _.default_type && (t.mime = ""), t.mime && t.mime.indexOf("/") > 0 ? e["Content-Type"] = t.mime : e["Content-Type"] = _.getType(t.mime || y.extname(t.object || "")) || "application/octet-stream"), t.content && (e["Content-Md5"] = b.createHash("md5").update(new n(t.content, "utf8")).digest("base64"), e["Content-Length"] || (e["Content-Length"] = t.content.length));
                ...
                }, D._getResource = function (t) {
                    var e = "/";
                    return t.bucket && (e += t.bucket + "/"), t.object && (e += t.object), e
                }, D._isIP = function (t) {
                    return L._isIP(t)
                }, D._escape = function (t) {
                    return O.encodeURIComponent(t).replace(/%2F/g, "/")
                }, D._getReqUrl = function (t) {
                    var e = {};
                    g(this.options.endpoint).to(e);
                    var r = this._isIP(e.hostname), n = this.options.cname;
                    !t.bucket || n || r || (e.host = t.bucket + "." + e.host);
                    var i = "/";
                    t.bucket && r && (i += t.bucket + "/"), t.object && (i += this._escape(t.object).replace(/\+/g, "%2B")), e.pathname = i;
                    var o = {};
                    if (t.query && S(o, t.query), t.subres) {
                        var a = {};
                        k.string(t.subres) ? a[t.subres] = "" : k.array(t.subres) ? t.subres.forEach(function (t) {
                            a[t] = ""
                        }) : a = t.subres, S(o, a)
                    }
                    return e.query = o, T.format(e)
                }, D._getUserAgent = function () {
                    var t = r && r.browser ? "js" : "nodejs", e = "aliyun-sdk-" + t + "/" + N.version,
                        n = j.description;
                    return !n && r && (n = "Node.js " + r.version.slice(1) + " on " + r.platform + " " + r.arch), this._checkUserAgent(e + " " + n)
                }, D._checkUserAgent = function (t) {
                    return t.replace(/\u03b1/, "alpha").replace(/\u03b2/, "beta")
                }, D.checkBrowserAndVersion = function (t, e) {
                    return M.name === t && M.version.split(".")[0] === e
                }, D.parseXML = function (t) {
                    return new p.default(function (e, r) {
                        n.isBuffer(t) && (t = t.toString()), w.parseString(t, {
                            explicitRoot: !1,
                            explicitArray: !1
                        }, function (t, n) {
                            t ? r(t) : e(n)
                    ...
                    return d.default.async(function (o) {
                        for (; ;) switch (o.prev = o.next) {
                            ...
                            case 33:
                                return v("generate error %j", e, "error"), o.abrupt("return", e);
                            case 35:
                            case"end":
                                return o.stop()
                        }
        ...
        3: [function (t, e, r) {
            (function (e) {
                ...
                var o = t("babel-runtime/core-js/array/from"), a = n(o), s = t("babel-runtime/core-js/promise"),
                    c = n(s), u = t("babel-runtime/regenerator"), l = n(u), p = t("is-type-of"), f = t("util"),
                    d = t("path"), h = t("mime"), m = t("copy-to"), v = r;
                v.multipartUpload = function (t, e, r) {
                    var n, i, o, a, s, c, u, f, m;
                    return l.default.async(function (v) {
                        for (; ;) switch (v.prev = v.next) {
                            case 0:
                                ...
                                return v.next = 5, l.default.awrap(this._resumeMultipart(r.checkpoint, r));
                            case 5:
                                return v.abrupt("return", v.sent);
                            case 6:
                                return n = 102400, r.mime || (p.file(e) ? r.mime = h.getType(d.extname(e.name)) : p.blob(e) ? r.mime = e.type : r.mime = h.getType(d.extname(e))), r.headers = r.headers || {}, this._convertMetaToHeaders(r.meta, r.headers), v.next = 12, l.default.awrap(this._getFileSize(e));
                            case 12:
                                if (!((i = v.sent) < n)) {
                                    v.next = 25;
                                    break
                                }
                                return o = this._createStream(e, 0, i), r.contentLength = i, v.next = 18, l.default.awrap(this.putStream(t, o, r));
                            case 18:
                                if (a = v.sent, !r || !r.progress) {
                                    v.next = 22;
                                    break
                                }
                                return v.next = 22, l.default.awrap(r.progress(1));
                            case 22:
                                return s = {
                                    res: a.res,
                                ...
                                }, (r.headers && r.headers["x-oss-callback"] || r.callback) && (s.data = a.data), v.abrupt("return", s);
                            case 25:
                            ...
                            case 27:
                                return v.next = 29, l.default.awrap(this.initMultipartUpload(t, r));
                            case 29:
                                if (c = v.sent, u = c.uploadId, f = this._getPartSize(i, r.partSize), m = {
                                    file: e,
                                    name: t,
                                    fileSize: i,
                                    partSize: f,
                                ...
                                return v.next = 36, l.default.awrap(r.progress(0, m, c.res));
                            case 36:
                                return v.next = 38, l.default.awrap(this._resumeMultipart(m, r));
                            case 38:
                                return v.abrupt("return", v.sent);
                            case 39:
                            case"end":
                ...
                }, v._resumeMultipart = function (t, e) {
                    var r, n, i, o, s, u, p, f, d, h, v, b, y, g, _, w, x, E, S;
                    return l.default.async(function (T) {
                        for (; ;) switch (T.prev = T.next) {
                            ...
                            case 3:
                                if (n = t.file, i = t.fileSize, o = t.partSize, s = t.uploadId, u = t.doneParts, p = t.name, f = [], u.length > 0 && m(u).to(f), d = this._divideParts(i, o), h = d.length, v = !1, b = function (r, i) {
                                    var o = this;
                                            ...
                                            for (; ;) switch (o.prev = o.next) {
                                                case 0:
                                                    ...
                                                    return f = d[i - 1], b = {
                                                        ...
                                                        size: f.end - f.start
                                                    }, o.next = 6, l.default.awrap(r._uploadPart(p, s, i, b));
                                                case 6:
                                                    if (y = o.sent, r.isCancel() || v) {
                                                        o.next = 15;
                                                        break
                                                    }
                                                    if (t.doneParts.push({
                            ...
                            case 17:
                                ...
                                throw this._makeCancelEvent();
                            case 20:
                                return T.next = 22, l.default.awrap(b(this, _[E]));
                            case 22:
                                E++, T.next = 17;
                                break;
                            case 25:
                            ...
                            case 29:
                                if (S = T.sent, v = !0, !this.isCancel()) {
                                    T.next = 34;
                                    break
                                }
                                throw b = null, this._makeCancelEvent();
                            case 34:
                                if (!(S && S.length > 0)) {
                                    T.next = 37;
                                    break
        ...
        4: [function (t, e, r) {
            ...
            var i = t("babel-runtime/core-js/promise"), o = n(i), a = t("babel-runtime/core-js/object/keys"), s = n(a),
                c = t("babel-runtime/regenerator"), u = n(c), l = t("utility"), p = t("fs"), f = t("is-type-of"),
                d = t("url"), h = t("copy-to"), m = t("path"), v = t("mime"), b = t("../common/callback"),
                y = t("../common/signUtils"), g = r;
            g.append = function (t, e, r) {
                ...
                return u.default.async(function (p) {
                    for (; ;) switch (p.prev = p.next) {
                        ...
                        case 6:
                            ...
                            return r.mime || (f.file(e) ? r.mime = v.getType(m.extname(e.name)) : r.mime = e.type), i = this._createStream(e, 0, e.size), p.next = 11, u.default.awrap(this._getFileSize(e));
                        case 11:
                        ...
                        case 19:
                            return r.headers = r.headers || {}, this._convertMetaToHeaders(r.meta, r.headers), a = r.method || "PUT", s = this._objectRequestParams(a, t, r), b.encodeCallback(s, r), s.mime = r.mime, s.content = n, s.successStatuses = [200], p.next = 29, u.default.awrap(this.request(s));
                        case 29:
                            return c = p.sent, l = {
                                name: t,
                ...
                return u.default.async(function (i) {
                    for (; ;) switch (i.prev = i.next) {
                        ...
                        case 4:
                            return n = i.sent, i.abrupt("return", {res: n.res});
                        case 6:
                        case"end":
                            return i.stop()
                    }
                ...
                var r = l.timestamp() + (e.expires || 1800), n = {bucket: this.options.bucket, object: t},
                    i = this._getResource(n);
                this.options.stsToken && (e["security-token"] = this.options.stsToken);
                var o = y._signatureForURL(this.options.accessKeySecret, e, i, r), a = d.parse(this._getReqUrl(n));
                return a.query = {
                ...
                if (e) "/" !== e[e.length - 1] && (e += "/"); else {
                    ...
                    var r = d.parse(e), n = this.options.bucket;
        ...
        6: [function (t, e, r) {
            (function (e) {
                ...
                var i = t("babel-runtime/core-js/object/keys"), o = n(i), a = t("babel-runtime/core-js/json/stringify"),
                    s = n(a);
        ...
        7: [function (t, e, r) {
            "use strict";
            var n = t("babel-runtime/regenerator"), i = function (t) {
                return t && t.__esModule ? t : {default: t}
            }(n), o = t("copy-to"), a = t("./callback"), s = r;
            s.listUploads = function (t, e) {
                ...
                return i.default.async(function (u) {
                    for (; ;) switch (u.prev = u.next) {
                        case 0:
                            return n = n || {}, a = {}, o(n).to(a), a.subres = {uploadId: e}, s = this._objectRequestParams("GET", t, a), s.query = r, s.xmlResponse = !0, s.successStatuses = [200], u.next = 10, i.default.awrap(this.request(s));
                        case 10:
                ...
                return i.default.async(function (c) {
                    for (; ;) switch (c.prev = c.next) {
                        case 0:
                            return this._stop(), r = r || {}, n = {}, o(r).to(n), n.subres = {uploadId: e}, a = this._objectRequestParams("DELETE", t, n), a.successStatuses = [204], c.next = 9, i.default.awrap(this.request(a));
                        case 9:
                ...
                return i.default.async(function (m) {
                    for (; ;) switch (m.prev = m.next) {
                        case 0:
                            ...
                            return c += "</CompleteMultipartUpload>", n = n || {}, p = {}, o(n).to(p), p.subres = {uploadId: e}, f = this._objectRequestParams("POST", t, p), a.encodeCallback(f, p), f.mime = "xml", f.content = c, f.headers && f.headers["x-oss-callback"] || (f.xmlResponse = !0), f.successStatuses = [200], m.next = 16, i.default.awrap(this.request(f));
                        case 16:
                            return d = m.sent, h = {
                                res: d.res,
                                bucket: f.bucket,
                ...
                return i.default.async(function (l) {
                    for (; ;) switch (l.prev = l.next) {
                        case 0:
                            return a = a || {}, s = {}, o(a).to(s), s.headers = {"Content-Length": n.size}, s.subres = {
                                partNumber: r,
                                uploadId: e
        ...
        8: [function (t, e, r) {
            ...
            var i = t("babel-runtime/regenerator"), o = n(i), a = t("babel-runtime/core-js/promise"), s = n(a), c = r;
            c._parallelNode = function (t, e, r, n) {
                ...
                return new s.default(function (i) {
                    ...
                    var l = function (t) {
                        var e = -1, r = t.length;
                        return function () {
                            return ++e < r && !n.isCancel() ? {value: t[e], key: e} : null
                        }
                    }(t), p = !1, f = 0, d = !1;
                    c()
                })
        ...
        9: [function (t, e, r) {
            (function (e) {
                ...
                var i = t("babel-runtime/core-js/json/stringify"), o = n(i), a = t("babel-runtime/core-js/object/keys"),
                    s = n(a), c = t("./../../shims/crypto/crypto.js"), u = t("is-type-of");
                r.buildCanonicalizedResource = function (t, e) {
                    ...
                    var p = this.buildCanonicalString(r.method, n, {headers: a, parameters: c}, i.toString());
        ...
        30: [function (t, e, r) {
            "use strict";
            r.__esModule = !0;
            var n = t("../core-js/object/define-property"), i = function (t) {
                return t && t.__esModule ? t : {default: t}
            }(n);
            r.default = function () {
                function t(t, e) {
        ...
        31: [function (t, e, r) {
            ...
            r.__esModule = !0;
            var i = t("../core-js/symbol/iterator"), o = n(i), a = t("../core-js/symbol"), s = n(a),
        ...
        33: [function (t, e, r) {
            ...
            function a(t) {
                for (var e, r = n(t), i = r[0], a = r[1], s = new f(o(t, i, a)), c = 0, u = a > 0 ? i - 4 : i, l = 0; l < u; l += 4) e = p[t.charCodeAt(l)] << 18 | p[t.charCodeAt(l + 1)] << 12 | p[t.charCodeAt(l + 2)] << 6 | p[t.charCodeAt(l + 3)], s[c++] = e >> 16 & 255, s[c++] = e >> 8 & 255, s[c++] = 255 & e;
            ...
            !function (e, n, i) {
                ...
                function t(t) {
                    ...
                    var i, o = e(/(ipod|iphone|ipad)/i).toLowerCase(), s = /like android/i.test(t),
                        ...
                        v = /windows phone/i.test(t), b = (/SamsungBrowser/i.test(t), !v && /windows/i.test(t)),
                        y = !o && !f && /macintosh/i.test(t), g = !c && !d && !h && !m && /linux/i.test(t),
                        _ = r(/edg([ea]|ios)\/(\d+(\.\d+)?)/i), w = e(/version\/(\d+(\.\d+)?)/i),
                    ...
                    /opera/i.test(t) ? i = {
                        ...
                        chrome: a,
                        version: e(/(?:chrome|crios|crmo)\/(\d+(\.\d+)?)/i)
                    } : c ? i = {name: "Android", version: w} : /safari|applewebkit/i.test(t) ? (i = {
                        name: "Safari",
                        safari: a
        ...
        37: [function (t, e, r) {
            (function (e) {
                ...
                var $ = t("base64-js"), Q = t("ieee754"), J = t("isarray");
                r.Buffer = o, r.SlowBuffer = m, r.INSPECT_MAX_BYTES = 50, o.TYPED_ARRAY_SUPPORT = void 0 !== e.TYPED_ARRAY_SUPPORT ? e.TYPED_ARRAY_SUPPORT : function () {
                    ...
                    if (t === e) return 0;
                    for (var r = t.length, n = e.length, i = 0, a = Math.min(r, n); i < a; ++i) if (t[i] !== e[i]) {
                        r = t[i], n = e[i];
                        break
                    }
                    ...
                    void 0 === n && (n = 0), void 0 === i && (i = this.length), e < 0 || r > t.length || n < 0 || i > this.length) throw new RangeError("out of range index");
                    if (n >= i && e >= r) return 0;
                    if (n >= i) return -1;
                    if (e >= r) return 1;
                    if (e >>>= 0, r >>>= 0, n >>>= 0, i >>>= 0, this === t) return 0;
                    for (var a = i - n, s = r - e, c = Math.min(a, s), u = this.slice(n, i), l = t.slice(e, r), p = 0; p < c; ++p) if (u[p] !== l[p]) {
                        a = u[p], s = l[p];
                        break
                    }
                ...
                o.prototype.slice = function (t, e) {
                    ...
                    var a;
                    if ("number" == typeof t) for (a = e; a < r; ++a) this[a] = t; else {
                        var s = o.isBuffer(t) ? t : G(new o(t, n).toString()), c = s.length;
        ...
        40: [function (t, e, r) {
            ...
            e.exports = n, n.prototype.withAccess = function (t) {
                ...
                for (var r = 0; r < e.length; r++) {
                    var n = e[r];
                    if (i(t, n)) {
                        var o = this.src.__lookupGetter__(n), a = this.src.__lookupSetter__(n);
                ...
                for (var e = this.keys || Object.keys(this.src), r = 0; r < e.length; r++) {
                    var n = e[r];
                    delete t[n];
                    var i = this.src.__lookupGetter__(n), o = this.src.__lookupSetter__(n);
        ...
        }, {"../../modules/_core": 62, "../../modules/es6.array.from": 130, "../../modules/es6.string.iterator": 142}],
        42: [function (t, e, r) {
            var n = t("../../modules/_core"), i = n.JSON || (n.JSON = {stringify: JSON.stringify});
        ...
        59: [function (t, e, r) {
            var n = t("./_to-iobject"), i = t("./_to-length"), o = t("./_to-absolute-index");
            e.exports = function (t) {
                return function (e, r, a) {
                    var s, c = n(e), u = i(c.length), l = o(a, u);
                    if (t && r != r) {
        ...
        60: [function (t, e, r) {
            var n = t("./_cof"), i = t("./_wks")("toStringTag"), o = "Arguments" == n(function () {
                return arguments
            }()), a = function (t, e) {
                try {
                    return t[e]
        ...
        63: [function (t, e, r) {
            "use strict";
            var n = t("./_object-dp"), i = t("./_property-desc");
            e.exports = function (t, e, r) {
        ...
        67: [function (t, e, r) {
            var n = t("./_is-object"), i = t("./_global").document, o = n(i) && n(i.createElement);
            e.exports = function (t) {
        ...
        69: [function (t, e, r) {
            var n = t("./_object-keys"), i = t("./_object-gops"), o = t("./_object-pie");
            e.exports = function (t) {
                var e = n(t), r = i.f;
        ...
        70: [function (t, e, r) {
            var n = t("./_global"), i = t("./_core"), o = t("./_ctx"), a = t("./_hide"), s = t("./_has"),
                c = function (t, e, r) {
                    var u, l, p, f = t & c.F, d = t & c.G, h = t & c.S, m = t & c.P, v = t & c.B, b = t & c.W,
                        y = d ? i : i[e] || (i[e] = {}), g = y.prototype, _ = d ? n : h ? n[e] : (n[e] || {}).prototype;
                    d && (r = e);
                    for (u in r) (l = !f && _ && void 0 !== _[u]) && s(y, u) || (p = l ? _[u] : r[u], y[u] = d && "function" != typeof _[u] ? r[u] : v && l ? o(p, n) : b && _[u] == p ? function (t) {
        ...
        72: [function (t, e, r) {
            var n = t("./_ctx"), i = t("./_iter-call"), o = t("./_is-array-iter"), a = t("./_an-object"),
                s = t("./_to-length"), c = t("./core.get-iterator-method"), u = {}, l = {},
                r = e.exports = function (t, e, r, p, f) {
                    var d, h, m, v, b = f ? function () {
                        return t
                    } : c(t), y = n(r, p, e ? 2 : 1), g = 0;
        ...
        80: [function (t, e, r) {
            var n = t("./_iterators"), i = t("./_wks")("iterator"), o = Array.prototype;
            e.exports = function (t) {
        ...
        84: [function (t, e, r) {
            "use strict";
            var n = t("./_object-create"), i = t("./_property-desc"), o = t("./_set-to-string-tag"), a = {};
        ...
        85: [function (t, e, r) {
            "use strict";
            var n = t("./_library"), i = t("./_export"), o = t("./_redefine"), a = t("./_hide"), s = t("./_iterators"),
                c = t("./_iter-create"), u = t("./_set-to-string-tag"), l = t("./_object-gpo"),
                p = t("./_wks")("iterator"), f = !([].keys && "next" in [].keys()), d = function () {
                    return this
                };
            e.exports = function (t, e, r, h, m, v, b) {
                ...
                var y, g, _, w = function (t) {
                    ...
                    k = T[p] || T["@@iterator"] || m && T[m], j = k || w(m), O = m ? E ? w("entries") : j : void 0,
                ...
                if (A && (_ = l(A.call(new t))) !== Object.prototype && _.next && (u(_, x, !0), n || "function" == typeof _[p] || a(_, p, d)), E && k && "values" !== k.name && (S = !0, j = function () {
                    ...
                    keys: v ? j : w("keys"),
                    entries: O
                }, b) for (g in y) g in T || o(T, g, y[g]); else i(i.P + i.F * (f || S), e, y);
                return y
            }
        }, {
            "./_export": 70,
        ...
        90: [function (t, e, r) {
            var n = t("./_uid")("meta"), i = t("./_is-object"), o = t("./_has"), a = t("./_object-dp").f, s = 0,
        ...
        91: [function (t, e, r) {
            var n = t("./_global"), i = t("./_task").set, o = n.MutationObserver || n.WebKitMutationObserver,
                a = n.process, s = n.Promise, c = "process" == t("./_cof")(a);
            e.exports = function () {
                ...
                if (c) r = function () {
                    ...
                    new o(u).observe(f, {characterData: !0}), r = function () {
                        f.data = p = !p
                    }
                }
                return function (n) {
        ...
        93: [function (t, e, r) {
            "use strict";
            var n = t("./_object-keys"), i = t("./_object-gops"), o = t("./_object-pie"), a = t("./_to-object"),
        ...
        94: [function (t, e, r) {
            var n = t("./_an-object"), i = t("./_object-dps"), o = t("./_enum-bug-keys"),
                a = t("./_shared-key")("IE_PROTO"), s = function () {
                }, c = function () {
                    var e, r = t("./_dom-create")("iframe"), n = o.length;
        ...
        95: [function (t, e, r) {
            var n = t("./_an-object"), i = t("./_ie8-dom-define"), o = t("./_to-primitive"), a = Object.defineProperty;
        ...
        96: [function (t, e, r) {
            var n = t("./_object-dp"), i = t("./_an-object"), o = t("./_object-keys");
        ...
        97: [function (t, e, r) {
            var n = t("./_object-pie"), i = t("./_property-desc"), o = t("./_to-iobject"), a = t("./_to-primitive"),
                s = t("./_has"), c = t("./_ie8-dom-define"), u = Object.getOwnPropertyDescriptor;
        ...
        98: [function (t, e, r) {
            var n = t("./_to-iobject"), i = t("./_object-gopn").f, o = {}.toString,
        ...
        99: [function (t, e, r) {
            var n = t("./_object-keys-internal"), i = t("./_enum-bug-keys").concat("length", "prototype");
        ...
        101: [function (t, e, r) {
            var n = t("./_has"), i = t("./_to-object"), o = t("./_shared-key")("IE_PROTO"), a = Object.prototype;
        ...
        102: [function (t, e, r) {
            var n = t("./_has"), i = t("./_to-iobject"), o = t("./_array-includes")(!1),
        ...
        103: [function (t, e, r) {
            var n = t("./_object-keys-internal"), i = t("./_enum-bug-keys");
        ...
        105: [function (t, e, r) {
            var n = t("./_export"), i = t("./_core"), o = t("./_fails");
            e.exports = function (t, e) {
                var r = (i.Object || {})[t] || Object[t], a = {}
        ...
        107: [function (t, e, r) {
            var n = t("./_an-object"), i = t("./_is-object"), o = t("./_new-promise-capability");
            e.exports = function (t, e) {
        ...
        111: [function (t, e, r) {
            "use strict";
            var n = t("./_global"), i = t("./_core"), o = t("./_object-dp"), a = t("./_descriptors"),
                s = t("./_wks")("species");
            e.exports = function (t) {
        ...
        112: [function (t, e, r) {
            var n = t("./_object-dp").f, i = t("./_has"), o = t("./_wks")("toStringTag");
            e.exports = function (t, e, r) {
                t && !i(t = r ? t : t.prototype, o) && n(t, o, {configurable: !0, value: e})
            }
        }, {"./_has": 74, "./_object-dp": 95, "./_wks": 128}],
        113: [function (t, e, r) {
            var n = t("./_shared")("keys"), i = t("./_uid");
            e.exports = function (t) {
                return n[t] || (n[t] = i(t))
            }
        }, {"./_shared": 114, "./_uid": 124}],
        114: [function (t, e, r) {
            var n = t("./_core"), i = t("./_global"), o = i["__core-js_shared__"] || (i["__core-js_shared__"] = {});
            (e.exports = function (t, e) {
        ...
        115: [function (t, e, r) {
            var n = t("./_an-object"), i = t("./_a-function"), o = t("./_wks")("species");
            e.exports = function (t, e) {
        ...
        116: [function (t, e, r) {
            var n = t("./_to-integer"), i = t("./_defined");
            e.exports = function (t) {
                return function (e, r) {
                    var o, a, s = String(i(e)), c = n(r), u = s.length;
        ...
        117: [function (t, e, r) {
            var n, i, o, a = t("./_ctx"), s = t("./_invoke"), c = t("./_html"), u = t("./_dom-create"),
                l = t("./_global"), p = l.process, f = l.setImmediate, d = l.clearImmediate, h = l.MessageChannel,
                m = l.Dispatch, v = 0, b = {}, y = function () {
                    var t = +this;
        ...
        118: [function (t, e, r) {
            var n = t("./_to-integer"), i = Math.max, o = Math.min;
            e.exports = function (t, e) {
        ...
        120: [function (t, e, r) {
            var n = t("./_iobject"), i = t("./_defined");
            e.exports = function (t) {
                return n(i(t))
            }
        }, {"./_defined": 65, "./_iobject": 79}],
        121: [function (t, e, r) {
            var n = t("./_to-integer"), i = Math.min;
            e.exports = function (t) {
        ...
        125: [function (t, e, r) {
            var n = t("./_global"), i = n.navigator;
            e.exports = i && i.userAgent || ""
        }, {"./_global": 73}],
        126: [function (t, e, r) {
            var n = t("./_global"), i = t("./_core"), o = t("./_library"), a = t("./_wks-ext"), s = t("./_object-dp").f;
            e.exports = function (t) {
        ...
        128: [function (t, e, r) {
            var n = t("./_shared")("wks"), i = t("./_uid"), o = t("./_global").Symbol, a = "function" == typeof o;
            (e.exports = function (t) {
                return n[t] || (n[t] = a && o[t] || (a ? o : i)("Symbol." + t))
            }).store = n
        }, {"./_global": 73, "./_shared": 114, "./_uid": 124}],
        129: [function (t, e, r) {
            var n = t("./_classof"), i = t("./_wks")("iterator"), o = t("./_iterators");
        ...
        130: [function (t, e, r) {
            "use strict";
            var n = t("./_ctx"), i = t("./_export"), o = t("./_to-object"), a = t("./_iter-call"),
            ...
            i(i.S + i.F * !t("./_iter-detect")(function (t) {
                ...
                from: function (t) {
                    var e, r, i, p, f = o(t), d = "function" == typeof this ? this : Array, h = arguments.length,
                        m = h > 1 ? arguments[1] : void 0, v = void 0 !== m, b = 0, y = l(f);
                    if (v && (m = n(m, h > 2 ? arguments[2] : void 0, 2)), void 0 == y || d == Array && s(y)) for (e = c(f.length), r = new d(e); e > b; b++) u(r, b, v ? m(f[b], b) : f[b]); else for (p = y.call(f), r = new d; !(i = p.next()).done; b++) u(r, b, v ? a(p, m, [i.value, b], !0) : i.value);
                    return r.length = b, r
                }
            })
        }, {
        ...
        131: [function (t, e, r) {
            "use strict";
            var n = t("./_add-to-unscopables"), i = t("./_iter-step"), o = t("./_iterators"), a = t("./_to-iobject");
        ...
        132: [function (t, e, r) {
            "use strict";
            var n = t("./_is-object"), i = t("./_object-gpo"), o = t("./_wks")("hasInstance"), a = Function.prototype;
        ...
        137: [function (t, e, r) {
            var n = t("./_to-object"), i = t("./_object-gpo");
        ...
        138: [function (t, e, r) {
            var n = t("./_to-object"), i = t("./_object-keys");
        ...
        140: [function (t, e, r) {
            "use strict";
            var n, i, o, a, s = t("./_library"), c = t("./_global"), u = t("./_ctx"), l = t("./_classof"),
                p = t("./_export"), f = t("./_is-object"), d = t("./_a-function"), h = t("./_an-instance"),
                m = t("./_for-of"), v = t("./_species-constructor"), b = t("./_task").set, y = t("./_microtask")(),
                g = t("./_new-promise-capability"), _ = t("./_perform"), w = t("./_user-agent"),
                x = t("./_promise-resolve"), E = c.TypeError, S = c.process, T = S && S.versions, k = T && T.v8 || "",
                j = c.Promise, O = "process" == l(S), A = function () {
                }, N = i = g.f, C = !!function () {
                    try {
                        var e = j.resolve(1), r = (e.constructor = {})[t("./_wks")("species")] = function (t) {
                            t(A, A)
                        };
            ...
            C || (j = function (t) {
            ...
            }), p(p.G + p.W + p.F * !C, {Promise: j}), t("./_set-to-string-tag")(j, "Promise"), t("./_set-species")("Promise"), a = t("./_core").Promise, p(p.S + p.F * !C, "Promise", {
                reject: function (t) {
                    var e = N(this);
                ...
                all: function (t) {
                    var e = this, r = N(e), n = r.resolve, i = r.reject, o = _(function () {
                        var r = [], o = 0, a = 1;
                        m(t, !1, function (t) {
                            var s = o++, c = !1;
                    ...
                    var e = this, r = N(e), n = r.reject, i = _(function () {
                        m(t, !1, function (t) {
        ...
        141: [function (t, e, r) {
            var n = t("./_export"), i = t("./_to-absolute-index"), o = String.fromCharCode, a = String.fromCodePoint;
        ...
        143: [function (t, e, r) {
            "use strict";
            var n = t("./_global"), i = t("./_has"), o = t("./_descriptors"), a = t("./_export"), s = t("./_redefine"),
                c = t("./_meta").KEY, u = t("./_fails"), l = t("./_shared"), p = t("./_set-to-string-tag"),
                f = t("./_uid"), d = t("./_wks"), h = t("./_wks-ext"), m = t("./_wks-define"), v = t("./_enum-keys"),
                b = t("./_is-array"), y = t("./_an-object"), g = t("./_is-object"), _ = t("./_to-iobject"),
                w = t("./_to-primitive"), x = t("./_property-desc"), E = t("./_object-create"),
                S = t("./_object-gopn-ext"), T = t("./_object-gopd"), k = t("./_object-dp"), j = t("./_object-keys"),
                O = T.f, A = k.f, N = S.f, C = n.Symbol, M = n.JSON, I = M && M.stringify, L = d("_hidden"),
                P = d("toPrimitive"), D = {}.propertyIsEnumerable, R = l("symbol-registry"), U = l("symbols"),
                B = l("op-symbols"), F = Object.prototype, q = "function" == typeof C, X = n.QObject,
                z = !X || !X.prototype || !X.prototype.findChild, G = o && u(function () {
                    return 7 != E(A({}, "a", {
                        get: function () {
                    ...
                    return t === F && Y(B, e, r), y(t), e = w(e, !0), y(r), i(U, e) ? (r.enumerable ? (i(t, L) && t[L][e] && (t[L][e] = !1), r = E(r, {enumerable: x(0, !1)})) : (i(t, L) || A(t, L, x(1, {})), t[L][e] = !0), G(t, e, r)) : A(t, e, r)
                }, V = function (t, e) {
                    y(t);
            ...
            q || (C = function () {
                ...
                return o && z && G(F, t, {configurable: !0, set: e}), H(t)
            ...
            }), C.prototype[P] || t("./_hide")(C.prototype, P, C.prototype.valueOf), p(C, "Symbol"), p(Math, "Math", !0), p(n.JSON, "JSON", !0)
        }, {
            "./_an-object": 58,
            "./_descriptors": 66,
            "./_enum-keys": 69,
        ...
        144: [function (t, e, r) {
            "use strict";
            var n = t("./_export"), i = t("./_core"), o = t("./_global"), a = t("./_species-constructor"),
        ...
        }, {"./_core": 62, "./_export": 70, "./_global": 73, "./_promise-resolve": 107, "./_species-constructor": 115}],
        145: [function (t, e, r) {
            "use strict";
            var n = t("./_export"), i = t("./_new-promise-capability"), o = t("./_perform");
            n(n.S, "Promise", {
                try: function (t) {
        ...
        150: [function (t, e, r) {
            (function (e) {
                ...
                var y = t("babel-runtime/helpers/typeof"), g = function (t) {
                    return t && t.__esModule ? t : {default: t}
                }(y);
                r.isArray = n, r.isBoolean = i, r.isNull = o, r.isNullOrUndefined = a, r.isNumber = s, r.isString = c, r.isSymbol = u, r.isUndefined = l, r.isRegExp = p, r.isObject = f, r.isDate = d, r.isError = h, r.isFunction = m, r.isPrimitive = v, r.isBuffer = e.isBuffer
            ...
            !function (e) {
                ...
                var u = function () {
                    ...
                    return function (n, o, l, p) {
                        ...
                        var d = l ? "getUTC" : "get", h = n[d + "Date"](), m = n[d + "Day"](), v = n[d + "Month"](),
                            b = n[d + "FullYear"](), y = n[d + "Hours"](), g = n[d + "Minutes"](),
                            _ = n[d + "Seconds"](), w = n[d + "Milliseconds"](), x = l ? 0 : n.getTimezoneOffset(),
                            E = a(n), S = s(n), T = {
                                d: h,
                                dd: i(h),
        ...
        159: [function (t, e, r) {
            r.read = function (t, e, r, n, i) {
                var o, a, s = 8 * i - n - 1, c = (1 << s) - 1, u = c >> 1, l = -7, p = r ? i - 1 : 0, f = r ? -1 : 1,
                    d = t[e + p];
                ...
                var a, s, c, u = 8 * o - i - 1, l = (1 << u) - 1, p = l >> 1,
                    f = 23 === i ? Math.pow(2, -24) - Math.pow(2, -77) : 0, d = n ? 0 : o - 1, h = n ? 1 : -1,
                    m = e < 0 || 0 === e && 1 / e < 0 ? 1 : 0;
        ...
        163: [function (t, e, r) {
            ...
            var i = t("core-util-is"), o = t("isstream"), a = t("is-class");
            Object.keys(i).map(function (t) {
                r[n(t)] = i[t]
            }), r.stream = o, r.readableStream = o.isReadable, r.writableStream = o.isWritable, r.duplexStream = o.isDuplex, r.class = a, r.finite = function (t) {
        ...
        }, {"core-util-is": 150, "is-class": 162, isstream: 165}],
        164: [function (t, e, r) {
            var n = {}.toString;
            e.exports = Array.isArray || function (t) {
            ...
            (function (e) {
                (function () {
                    ...
                    function a(t, e) {
                        ...
                        if ("number" == typeof n && n > -1 && n <= _) for (; ++r < n;) e(t[r], r, t); else c(t, e)
                    }
                    ...
                    function h(t) {
                        ...
                        var n = v, i = t && "object" == typeof t && "String" != u(t);
                        i && (n = t, t = null);
                        var a = n.navigator || {}, m = a.userAgent || "";
                        t || (t = m);
                        var b, y, g = i ? !!a.likeChrome : /\bChrome\b/.test(t) && !/internal|\n/i.test(S.toString()),
                            _ = i ? "Object" : "ScriptBridgingProxyObject", x = i ? "Object" : "Environment",
                            E = i && n.java ? "JavaPackage" : u(n.java), T = i ? "Object" : "RuntimeObject",
                            k = /\bJava/.test(E) && n.java, j = k && u(n.environment) == x, O = k ? "a" : "α",
                            A = k ? "b" : "β", N = n.document || {}, C = n.operamini || n.opera,
                            M = w.test(M = i && C ? C["[[Class]]"] : u(C)) ? M : C = null, I = t, L = [], P = null,
                            D = t == m, R = D && C && "function" == typeof C.version && C.version(), U = function (e) {
                                return f(e, function (e, r) {
                            ...
                            F = e([{label: "BlackBerry", pattern: "BB10"}, "BlackBerry", {
                                label: "Galaxy S",
                                pattern: "GT-I9000"
                        ...
                        }), (b = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(I)) && !/\bi686\b/i.test(I) ? (X && (X.architecture = 64, X.family = X.family.replace(RegExp(" *" + b), "")), B && (/\bWOW64\b/i.test(t) || D && /\w(?:86|32)$/.test(a.cpuClass || a.platform) && !/\bWin64; x64\b/i.test(t)) && L.unshift("32-bit")) : X && /^OS X/.test(X.family) && "Chrome" == B && parseFloat(R) >= 39 && (X.architecture = 64), t || (t = null);
                        var z = {};
                    ...
                    var m = {function: !0, object: !0}, v = m[typeof window] && window || this, b = m[typeof n] && n,
                        y = m[typeof r] && r && !r.nodeType && r, g = b && y && "object" == typeof e && e;
        ...
        172: [function (e, r, n) {
            (function (e) {
                !function (i) {
                    ...
                    function d(t) {
                        var e, r, n, i, a, s, c, p, d, h, m = [], v = t.length, b = 0, y = A, g = O;
                        for (r = t.lastIndexOf(N), r < 0 && (r = 0), n = 0; n < r; ++n) t.charCodeAt(n) >= 128 && o("not-basic"), m.push(t.charCodeAt(n));
                        for (i = r > 0 ? r + 1 : 0; i < v;) {
                            for (a = b, s = 1, c = E; i >= v && o("invalid-input"), p = l(t.charCodeAt(i++)), (p >= E || p > D((x - b) / s)) && o("overflow"), b += p * s, d = c <= g ? S : c >= g + T ? T : c - g, !(p < d); c += E) h = E - d, s > D(x / h) && o("overflow"), s *= h;
                            e = m.length + 1, g = f(b - a, e, 0 == a), D(b / e) > x - y && o("overflow"), y += D(b / e), b %= e, m.splice(b++, 0, y)
                        }
                        return u(m)
                    }
                    ...
                    function h(t) {
                        ...
                        for (n = i = _.length, i && _.push(N); n < v;) {
                            ...
                            for (b = n + 1, u - e > D((x - r) / b) && o("overflow"), r += (u - e) * b, e = u, s = 0; s < v; ++s) if (m = t[s], m < e && ++r > x && o("overflow"), m == e) {
                                for (l = r, d = E; h = d <= a ? S : d >= a + T ? T : d - a, !(l < h); d += E) g = l - h, y = E - h, _.push(R(p(h + g % y, 0))), l = D(g / y);
                    ...
                    var b = "object" == typeof n && n && !n.nodeType && n,
                        y = "object" == typeof r && r && !r.nodeType && r, g = "object" == typeof e && e;
                    g.global !== g && g.window !== g && g.self !== g || (i = g);
                    var _, w, x = 2147483647, E = 36, S = 1, T = 26, k = 38, j = 700, O = 72, A = 128, N = "-",
                        C = /^xn--/, M = /[^\x20-\x7E]/, I = /[\x2E\u3002\uFF0E\uFF61]/g, L = {
                            overflow: "Overflow: input needs wider integers to process",
                            "not-basic": "Illegal input >= 0x80 (not a basic code point)",
                            "invalid-input": "Invalid input"
                        }, P = E - S, D = Math.floor, R = String.fromCharCode;
                    if (_ = {
                        version: "1.4.1",
                        ...
                        return _
                    }); else if (b && y) if (r.exports == b) y.exports = _; else for (w in _) _.hasOwnProperty(w) && (b[w] = _[w]); else i.punycode = _
                }(this)
            }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
        }, {}],
        173: [function (t, e, r) {
            ...
            e.exports = function (t, e, r, o) {
                ...
                c > 0 && u > c && (u = c);
                for (var l = 0; l < u; ++l) {
                    var p, f, d, h, m = t[l].replace(s, "%20"), v = m.indexOf(r);
                    v >= 0 ? (p = m.substr(0, v), f = m.substr(v + 1)) : (p = m, f = ""), d = decodeURIComponent(p), h = decodeURIComponent(f), n(a, d) ? i(a[d]) ? a[d].push(h) : a[d] = [a[d], h] : a[d] = h
                }
                return a
            };
        ...
        179: [function (t, e, r) {
            (function (r, n) {
                ...
                function v(t) {
                    ...
                    e.needReadable = !1, e.emittedReadable || (z("emitReadable", e.flowing), e.emittedReadable = !0, e.sync ? L.nextTick(b, t) : b(t))
                }
                ...
                function g(t, e) {
                    for (var r = e.length; !e.reading && !e.flowing && !e.ended && e.length < e.highWaterMark && (z("maybeReadMore read 0"), t.read(0), r !== e.length);) r = e.length;
                    e.readingMore = !1
                }
                ...
                function O(t, e) {
                    var r = B.allocUnsafe(t), n = e.head, i = 1;
                ...
                var M = t("babel-runtime/core-js/object/get-prototype-of"), I = function (t) {
                    return t && t.__esModule ? t : {default: t}
                }(M), L = t("process-nextick-args");
                e.exports = c;
                var P, D = t("isarray");
                c.ReadableState = s;
                var R = (t("events").EventEmitter, function (t, e) {
                    return t.listeners(e).length
                }), U = t("./internal/streams/stream"), B = t("safe-buffer").Buffer, F = n.Uint8Array || function () {
                }, q = t("core-util-is");
                q.inherits = t("inherits");
                var X = t("util"), z = void 0;
                z = X && X.debuglog ? X.debuglog("stream") : function () {
                };
                var G, H = t("./internal/streams/BufferList"), W = t("./internal/streams/destroy");
                q.inherits(c, U);
                ...
                c.prototype.read = function (t) {
                    ...
                    if (0 !== t && (e.emittedReadable = !1), 0 === t && e.needReadable && (e.length >= e.highWaterMark || e.ended)) return z("read: emitReadable", e.length, e.ended), 0 === e.length && e.ended ? A(this) : v(this), null;
                    ...
                    function o() {
                        z("cleanup"), t.removeListener("close", u), t.removeListener("finish", l), t.removeListener("drain", v), t.removeListener("error", c), t.removeListener("unpipe", n), f.removeListener("end", i), f.removeListener("end", p), f.removeListener("data", s), b = !0, !d.awaitDrain || t._writableState && !t._writableState.needDrain || v()
                    }

                    function s(e) {
                        z("ondata"), y = !1, !1 !== t.write(e) || y || ((1 === d.pipesCount && d.pipes === t || d.pipesCount > 1 && -1 !== C(d.pipes, t)) && !b && (z("false write response, pause", f._readableState.awaitDrain), f._readableState.awaitDrain++, y = !0), f.pause())
                    }
                    ...
                    var h = (!e || !1 !== e.end) && t !== r.stdout && t !== r.stderr, m = h ? i : p;
            ...
            (function (r, n) {
                ...
                function w(t, e) {
                    ...
                    if (t._writev && r && r.next) {
                        ...
                        for (; r;) {
                            var u = r.chunk, l = r.encoding, p = r.callback;
                ...
                var O = t("babel-runtime/core-js/object/define-property"), A = i(O),
                    N = t("babel-runtime/core-js/symbol/has-instance"), C = i(N), M = t("babel-runtime/core-js/symbol"),
                    I = i(M), L = t("babel-runtime/core-js/set-immediate"), P = i(L), D = t("process-nextick-args");
                e.exports = l;
                var R,
                ...
                var F = {deprecate: t("util-deprecate")}, q = t("./internal/streams/stream"),
                    X = t("safe-buffer").Buffer, z = n.Uint8Array || function () {
                ...
                "function" == typeof I.default && C.default && "function" == typeof Function.prototype[C.default] ? (H = Function.prototype[C.default], (0, A.default)(l, C.default, {
                    ...
                    var n = this._writableState, i = !1, o = !n.objectMode && s(t);
        ...
        190: [function (t, e, r) {
            !function (t) {
                ...
                function r(t, e, r, n) {
                    var o = e && e.prototype instanceof i ? e : i, a = Object.create(o.prototype), s = new d(n || []);
                ...
                function l(t, e) {
                    ...
                    if (r === v) {
                        if (e.delegate = null, "throw" === e.method) {
                            if (t.iterator.return && (e.method = "return", e.arg = v, l(t, e), "throw" === e.method)) return A;
                    ...
                    if (t) {
                        ...
                        if (!isNaN(t.length)) {
                            var r = -1, n = function e() {
                                for (; ++r < t.length;) if (y.call(t, r)) return e.value = t[r], e.done = !1, e;
                ...
                var v, b = Object.prototype, y = b.hasOwnProperty, g = "function" == typeof Symbol ? Symbol : {},
                    _ = g.iterator || "@@iterator", w = g.asyncIterator || "@@asyncIterator",
                    x = g.toStringTag || "@@toStringTag", E = "object" == typeof e, S = t.regeneratorRuntime;
                if (S) return void(E && (e.exports = S));
                S = t.regeneratorRuntime = E ? e.exports : {}, S.wrap = r;
                var T = "suspendedStart", k = "suspendedYield", j = "executing", O = "completed", A = {}, N = {};
                N[_] = function () {
                    return this
                };
                var C = Object.getPrototypeOf, M = C && C(C(h([])));
        ...
        192: [function (t, e, r) {
            (function (e) {
                ...
                var i = t("babel-runtime/core-js/string/from-code-point"), o = n(i),
                    a = t("babel-runtime/core-js/json/stringify"), s = n(a), c = t("babel-runtime/helpers/typeof"),
                    u = n(c), l = t("babel-runtime/core-js/object/define-property"), p = n(l),
                    f = t("babel-runtime/core-js/object/keys"), d = n(f), h = t("babel-runtime/core-js/object/create"),
                    m = n(h);
                !function (r) {
                    function n(t, e) {
                        if (!(this instanceof n)) return new n(t, e);
                    ...
                    function O(t, e) {
                        var r = t.indexOf(":"), n = r < 0 ? ["", t] : t.split(":"), i = n[0], o = n[1];
                    ...
                    function A(t) {
                        ...
                        if (t.opt.xmlns) {
                            var e = O(t.attribName, !0), r = e.prefix, n = e.local;
                    ...
                    function N(t, e) {
                        if (t.opt.xmlns) {
                            ...
                            for (var o = 0, a = t.attribList.length; o < a; o++) {
                                var c = t.attribList[o], u = c[0], l = c[1], p = O(u, !0), f = p.prefix, h = p.local,
                                    m = "" === f ? "" : r.ns[f] || "",
                                    v = {name: u, value: l, prefix: f, local: h, uri: m};
                                f && "xmlns" !== f && !m && (k(t, "Unbound namespace prefix: " + (0, s.default)(f)), v.uri = f), t.tag.attributes[u] = v, w(t, "onattribute", v)
                            }
                    ...
                    function C(t) {
                        ...
                        var e = t.tags.length, r = t.tagName;
                    ...
                    function M(t) {
                        var e, r = t.entity, n = r.toLowerCase(), i = "";
                        ...
                        for (var r = 0, n = ""; ;) {
                            ...
                            switch (e.trackPosition && (e.position++, "\n" === n ? (e.line++, e.column = 0) : e.column++), e.state) {
                                ...
                                case V.DOCTYPE_QUOTED:
                                    ...
                                    continue;
                                case V.DOCTYPE_DTD:
                                    e.doctype += n, "]" === n ? e.state = V.DOCTYPE : v(n) && (e.state = V.DOCTYPE_DTD_QUOTED, e.q = n);
                                    continue;
                    ...
                    f.prototype = (0, m.default)(R.prototype, {constructor: {value: f}}), f.prototype.write = function (r) {
                    ...
                    var B = "[CDATA[", F = "DOCTYPE", q = "http://www.w3.org/XML/1998/namespace",
                        X = "http://www.w3.org/2000/xmlns/", z = {xml: q, xmlns: X},
                    ...
                    r.STATE = {
                        ...
                        SCRIPT: V++,
                        SCRIPT_ENDING: V++
                    }, r.XML_ENTITIES = {amp: "&", gt: ">", lt: "<", quot: '"', apos: "'"}, r.ENTITIES = {
                        amp: "&",
                        gt: ">",
                        lt: "<",
                        quot: '"',
                        ...
                        var e = r.ENTITIES[t], n = "number" == typeof e ? String.fromCharCode(e) : e;
                        r.ENTITIES[t] = n
                    });
                    for (var K in r.STATE) r.STATE[r.STATE[K]] = K;
                    V = r.STATE, o.default || function () {
                        var t = String.fromCharCode, e = Math.floor, r = function () {
                            var r, n, i = [], o = -1, a = arguments.length;
                            if (!a) return "";
                            for (var s = ""; ++o < a;) {
        ...
        194: [function (t, e, r) {
            (function (e) {
                var n = t("./lib/request"), i = t("./lib/response"), o = t("xtend"), a = t("builtin-status-codes"),
                    s = t("url"), c = r;
        ...
        196: [function (t, e, r) {
            (function (r, n, i) {
                ...
                var s = t("babel-runtime/core-js/object/keys"), c = function (t) {
                    ...
                    d = t("to-arraybuffer"), h = p.IncomingMessage, m = p.readyStates, v = e.exports = function (t) {
                        var e = this;
                ...
                l(v, f.Writable), v.prototype.setHeader = function (t, e) {
                    var r = this, n = t.toLowerCase();
                    ...
                    var t = this;
                    if (!t._destroyed) {
                        var e = t._opts, o = t._headers, a = null;
                ...
                var b = ["accept-charset", "accept-encoding", "access-control-request-headers", "access-control-request-method", "connection", "content-length", "cookie", "cookie2", "date", "dnt", "expect", "host", "keep-alive", "origin", "referer", "te", "trailer", "transfer-encoding", "upgrade", "user-agent", "via"]
        ...
        198: [function (t, e, r) {
            ...
            function u(t) {
                var e = this.lastTotal - this.lastNeed, r = c(this, t, e);
            ...
            var y = t("safe-buffer").Buffer, g = y.isEncoding || function (t) {
        ...
        199: [function (t, e, r) {
            (function (e, n) {
                ...
                var o = t("process/browser.js").nextTick, a = Function.prototype.apply, s = Array.prototype.slice,
                    c = {}, u = 0;
        ...
        201: [function (t, e, r) {
            ...
            var l = /^([a-z0-9.+-]+:)/i, p = /:[0-9]*$/, f = /^(\/\/?(?!\/)[^\?\s]*)(\?[^\s]*)?$/,
                d = ["<", ">", '"', "`", " ", "\r", "\n", "\t"], h = ["{", "}", "|", "\\", "^", "`"].concat(d),
                m = ["'"].concat(h), v = ["%", "/", "?", ";", "#"].concat(m), b = ["/", "?", "#"],
                y = /^[+a-z0-9A-Z_-]{0,63}$/, g = /^([+a-z0-9A-Z_-]{0,63})(.*)$/,
            ...
            n.prototype.parse = function (t, e, r) {
                ...
                var n = t.indexOf("?"), i = -1 !== n && n < t.indexOf("#") ? "?" : "#", o = t.split(i), a = /\\/g;
                ...
                if (!w[d] && (S || d && !x[d])) {
                    ...
                    if (!N) for (var C = this.hostname.split(/\./), k = 0, M = C.length; k < M; k++) {
                        ...
                        if (I && !I.match(y)) {
                            ...
                            if (!L.match(y)) {
                                var R = C.slice(0, k), U = C.slice(k + 1), B = I.match(g);
                ...
                var b = r.pathname && "/" === r.pathname.charAt(0),
                    y = t.host || t.pathname && "/" === t.pathname.charAt(0), g = y || b || r.host && t.pathname, _ = g,
                    E = r.pathname && r.pathname.split("/") || [], h = t.pathname && t.pathname.split("/") || [],
                ...
                for (var k = E.slice(-1)[0], j = (r.host || t.host || E.length > 1) && ("." === k || ".." === k) || "" === k, O = 0, A = E.length; A >= 0; A--) k = E[A], "." === k ? E.splice(A, 1) : ".." === k ? (E.splice(A, 1), O++) : O && (E.splice(A, 1), O--);
        ...
        205: [function (t, e, r) {
            (function (e, n) {
                ...
                function f(t, e, r, n, i, o) {
                    var a, s, u;
                    if (u = Object.getOwnPropertyDescriptor(e, i) || {value: e[i]}, u.get ? s = u.set ? t.stylize("[Getter/Setter]", "special") : t.stylize("[Getter]", "special") : u.set && (s = t.stylize("[Setter]", "special")), C(n, i) || (a = "[" + i + "]"), s || (t.seen.indexOf(u.value) < 0 ? (s = v(r) ? c(t, u.value, null) : c(t, u.value, r - 1), s.indexOf("\n") > -1 && (s = o ? s.split("\n").map(function (t) {
                        return "  " + t
                    }).join("\n").substr(2) : "\n" + s.split("\n").map(function (t) {
                        return "   " + t
                ...
                r.debuglog = function (t) {
                    ...
                    date: "magenta",
                    regexp: "red"
                }, r.isArray = h, r.isBoolean = m, r.isNull = v, r.isNullOrUndefined = b, r.isNumber = y, r.isString = g, r.isSymbol = _, r.isUndefined = w, r.isRegExp = x, r.isObject = E, r.isDate = S, r.isError = T, r.isFunction = k, r.isPrimitive = j, r.isBuffer = t("./support/isBuffer");
        ...
        207: [function (t, e, r) {
            ...
            var i = t("babel-runtime/helpers/typeof"), o = n(i), a = t("babel-runtime/core-js/object/keys"), s = n(a);
            (function () {
        ...
        209: [function (t, e, r) {
            ...
            var i = t("babel-runtime/core-js/object/get-own-property-names"), o = n(i),
                a = t("babel-runtime/core-js/object/keys"), s = n(a), c = t("babel-runtime/helpers/typeof"), u = n(c);
            (function () {
                ...
                p = t("sax"), i = t("events"), e = t("./bom"), l = t("./processors"), f = t("timers").setImmediate, n = t("./defaults").defaults, a = function (t) {
                            ...
                            return function () {
                                ...
                                if (d = n.pop(), f = d["#name"], t.options.explicitChildren && t.options.preserveChildrenOrder || delete d["#name"], !0 === d.cdata && (r = d.cdata, delete d.cdata), b = n[n.length - 1], d[e].match(/^\s*$/) && !r ? (i = d[e], delete d[e]) : (t.options.trim && (d[e] = d[e].trim()), t.options.normalize && (d[e] = d[e].replace(/\s{2,}/g, " ").trim()), d[e] = t.options.valueProcessors ? c(t.options.valueProcessors, d[e], f) : d[e], 1 === (0, s.default)(d).length && e in d && !t.EXPLICIT_CHARKEY && (d = d[e])), a(d) && (d = "" !== t.options.emptyTag ? t.options.emptyTag : i), null != t.options.validator && (y = "/" + function () {
                                    ...
                                    if (b) {
                                        ...
                                        b[t.options.childkey].push(h), delete d["#name"], 1 === (0, s.default)(d).length && e in d && !t.EXPLICIT_CHARKEY && (d = d[e])
                                    }
        ...
        212: [function (t, e, r) {
            ...
            var i = t("babel-runtime/core-js/object/get-prototype-of"), o = n(i), a = t("babel-runtime/helpers/typeof"),
                s = n(a), c = t("babel-runtime/core-js/object/assign"), u = n(c);
            (function () {
                var t, r, n, i, a, c, l = [].slice, p = {}.hasOwnProperty;
                t = function () {
                    var t, e, r, n, o, a;
                    if (a = arguments[0], o = 2 <= arguments.length ? l.call(arguments, 1) : [], i(u.default)) u.default.apply(null, arguments); else for (t = 0, r = o.length; t < r; t++) if (null != (n = o[t])) for (e in n) p.call(n, e) && (a[e] = n[e]);
                    return a
                }, i = function (t) {
        ...
        213: [function (t, e, r) {
            "use strict";
            var n = t("babel-runtime/core-js/object/create"), i = function (t) {
                return t && t.__esModule ? t : {default: t}
            }(n);
            (function () {
                e.exports = function () {
            ...
            (function () {
                ...
                _ = t("./Utility"), y = _.isObject, b = _.isFunction, g = _.isPlainObject, p = t("./XMLElement"), n = t("./XMLCData"), i = t("./XMLComment"), d = t("./XMLRaw"), v = t("./XMLText"), f = t("./XMLProcessingInstruction"), u = t("./XMLDeclaration"), l = t("./XMLDocType"), o = t("./XMLDTDAttList"), s = t("./XMLDTDEntity"), a = t("./XMLDTDElement"), c = t("./XMLDTDNotation"), r = t("./XMLAttribute"), m = t("./XMLStringifier"), h = t("./XMLStringWriter"), e.exports = function () {
                    ...
                    return t.prototype.node = function (t, e, r) {
                        ...
                        if (null != t && (t = t.valueOf()), y(t)) for (n in t) w.call(t, n) && (i = t[n], this.attribute(n, i)); else b(e) && (e = e.apply()), this.options.skipNullAttributes && null == e || (this.currentNode.attributes[t] = new r(this, t, e));
                        return this
                        ...
                        var r, n, i, o, a;
                        if (this.openCurrent(), null != t && (t = t.valueOf()), null != e && (e = e.valueOf()), Array.isArray(t)) for (r = 0, o = t.length; r < o; r++) n = t[r], this.instruction(n); else if (y(t)) for (n in t) w.call(t, n) && (i = t[n], this.instruction(n, i)); else b(e) && (e = e.apply()), a = new f(this, t, e), this.onData(this.writer.processingInstruction(a, this.currentLevel + 1));
                        return this
            ...
            (function () {
                ...
                s = t("./Utility"), a = s.isObject, o = s.isFunction, n = t("./XMLNode"), r = t("./XMLAttribute"), e.exports = function (t) {
                    ...
                    return c(e, t), e.prototype.clone = function () {
                        ...
                        var n, i;
                        if (null != t && (t = t.valueOf()), a(t)) for (n in t) u.call(t, n) && (i = t[n], this.attribute(n, i)); else o(e) && (e = e.apply()), this.options.skipNullAttributes && null == e || (this.attributes[t] = new r(this, t, e));
                        return this
                    }, e.prototype.removeAttribute = function (t) {
                        var e, r, n;
                        if (null == t) throw new Error("Missing attribute name");
                        if (t = t.valueOf(), Array.isArray(t)) for (r = 0, n = t.length; r < n; r++) e = t[r], delete this.attributes[e]; else delete this.attributes[t];
                        return this
                    }, e.prototype.toString = function (t) {
        ...
        }, {"./Utility": 212, "./XMLAttribute": 213, "./XMLNode": 225, "babel-runtime/core-js/object/create": 18}],
        225: [function (t, e, r) {
            "use strict";
            (function () {
                ...
                d = t("./Utility"), f = d.isObject, p = d.isFunction, l = d.isEmpty, a = null, r = null, n = null, i = null, o = null, c = null, u = null, s = null, e.exports = function () {
                    ...
                    return e.prototype.element = function (t, e, r) {
                        ...
                        if (c = null, null == e && (e = {}), e = e.valueOf(), f(e) || (m = [e, r], r = m[0], e = m[1]), null != t && (t = t.valueOf()), Array.isArray(t)) for (o = 0, u = t.length; o < u; o++) i = t[o], c = this.element(i); else if (p(t)) c = this.element(t.apply()); else if (f(t)) {
                            for (s in t) if (h.call(t, s)) if (v = t[s], p(v) && (v = v.apply()), f(v) && l(v) && (v = null), !this.options.ignoreDecorators && this.stringify.convertAttKey && 0 === s.indexOf(this.stringify.convertAttKey)) c = this.attribute(s.substr(this.stringify.convertAttKey.length), v); else if (!this.options.separateArrayItems && Array.isArray(v)) for (a = 0, d = v.length; a < d; a++) i = v[a], n = {}, n[s] = i, c = this.element(n); else f(v) ? (c = this.element(s), c.element(v)) : c = this.element(s, v)
                        ...
                        var r, n, i, o, a;
                        if (null != t && (t = t.valueOf()), null != e && (e = e.valueOf()), Array.isArray(t)) for (o = 0, a = t.length; o < a; o++) r = t[o], this.instruction(r); else if (f(t)) for (r in t) h.call(t, r) && (n = t[r], this.instruction(r, n)); else p(e) && (e = e.apply()), i = new s(this, t, e), this.children.push(i);
                        return this
                        ...
                        for (n = this.document(), i = new o(n, t, e), p = n.children, a = s = 0, u = p.length; s < u; a = ++s) if ((r = p[a]) instanceof o) return n.children[a] = i, i;
                        for (f = n.children, a = c = 0, l = f.length; c < l; a = ++c) if (r = f[a], r.isRoot) return n.children.splice(a, 0, i), i;
        ...
        229: [function (t, e, r) {
            ...
            (function () {
                ...
                c = t("./XMLDeclaration"), u = t("./XMLDocType"), r = t("./XMLCData"), n = t("./XMLComment"), l = t("./XMLElement"), f = t("./XMLRaw"), d = t("./XMLText"), p = t("./XMLProcessingInstruction"), i = t("./XMLDTDAttList"), o = t("./XMLDTDElement"), a = t("./XMLDTDEntity"), s = t("./XMLDTDNotation"), h = t("./XMLWriterBase"), e.exports = function (t) {
                    ...
                    return m(e, t), e.prototype.document = function (t) {
                        var e, r, i, o, a;
                        for (this.textispresent = !1, o = "", a = t.children, r = 0, i = a.length; r < i; r++) e = a[r], o += function () {
                            switch (!1) {
                                case!(e instanceof c):
                        ...
                        e || (e = 0), w = !1, this.textispresent ? (this.newline = "", this.pretty = !1) : (this.newline = this.newlinedefault, this.pretty = this.prettydefault), _ = this.space(e), m = "", m += _ + "<" + t.name, b = t.attributes;
                        ...
                        if (0 === t.children.length || t.children.every(function (t) {
                            ...
                            for (this.textispresent && (this.newline = "", this.pretty = !1, _ = this.space(e)), m += ">" + this.newline, g = t.children, s = 0, u = g.length; s < u; s++) o = g[s], m += function () {
                                switch (!1) {
                                    case!(o instanceof r):
            ...
            function i(t, e) {
                ...
                return r || o("algorithm:", t, "is not yet supported"), {
                    update: function (t) {
                        ...
                        var o = a.concat(i), s = e ? n(r, e, o) : r(o);
        ...
        239: [function (t, e, r) {
            "use strict";
            var n = t("./helpers"), i = function (t, e) {
                var r = (65535 & t) + (65535 & e);
                return (t >> 16) + (e >> 16) + (r >> 16) << 16 | 65535 & r
            }, o = function (t, e) {
                return t >>> e | t << 32 - e
                ...
                for (var b = 0; b < t.length; b += 16) {
                    r = x[0], n = x[1], o = x[2], a = x[3], d = x[4], h = x[5], m = x[6], v = x[7];
                    for (var y = 0; y < 64; y++) E[y] = y < 16 ? t[y + b] : i(i(i(f(E[y - 2]), E[y - 7]), p(E[y - 15])), E[y - 16]), g = i(i(i(i(v, l(d)), s(d, h, m)), w[y]), E[y]), _ = i(u(r), c(r, n, o)), v = m, m = h, h = d, d = i(a, g), a = o, o = n, n = r, r = i(g, _);
                    x[0] = i(r, x[0]), x[1] = i(n, x[1]), x[2] = i(o, x[2]), x[3] = i(a, x[3]), x[4] = i(d, x[4]), x[5] = i(h, x[5]), x[6] = i(m, x[6]), x[7] = i(v, x[7])
                }
                return x
            };
            e.exports = function (t) {
        ...
        240: [function (e, r, n) {
            (function (i) {
                ...
                var a = e("babel-runtime/core-js/object/create"), s = o(a),
                    c = e("babel-runtime/helpers/classCallCheck"), u = o(c), l = e("babel-runtime/helpers/createClass"),
                    p = o(l), f = e("babel-runtime/helpers/typeof"), d = o(f);
                !function (e) {
                    ...
                    return function t(r, n, i) {
                                ...
                                return (0, p.default)(t, [{
                                    ...
                                    key: "getType", value: function (t) {
                                        ...
                                        var e = t.replace(/^.*[\/\\]/, "").toLowerCase(),
                                            r = e.replace(/^.*\./, "").toLowerCase(), n = e.length < t.length;
                        ...
                        }, {"./Mime": 1, "./types/other": 3, "./types/standard": 4}], 3: [function (t, e, r) {
                            e.exports = {
        ...
        242: [function (t, e, r) {
            (function (e, n) {
                ...
                var s, c = t("babel-runtime/core-js/json/stringify"), u = i(c), l = t("babel-runtime/helpers/typeof"),
                    p = i(l), f = t("util"), d = t("url"), h = t("http"), m = t("https"), v = t("debug")("urllib"),
                    b = t("humanize-ms"), y = 0, g = Math.pow(2, 31) - 10, _ = /^https?:\/\//i;
                ...
                r.request = function (e, n, i) {
                        ...
                        if (a.followRedirect && statuses.redirect[t.statusCode]) {
                            ...
                            if (n) {
                                if (!(a._followRedirectCount > a.maxRedirects)) {
                                    ...
                                    v("Request#%d %s: `redirected` from %s to %s", A, U.path, i, o), l(), a.headers && a.headers.Host && _.test(n) && (a.headers.Host = null);
                                    var c = s;
                                    return s = null, r.requestWithCallback(o, a, c), {redirect: !0, error: null}
                                }
                    ...
                    function T(t) {
                        ...
                        if (t.on("close", function () {
                            ...
                            et = !0, v("Request#%d %s: `res aborted` event emit, total size %d", A, i, Z)
                        }), ot) {
                            var e = E(t);
                            return e.redirect ? void t.resume() : e.error ? (t.resume(), ot.end(), x(e.error, null, t)) : (!1 === a.consumeWriteStream ? t.on("end", x.bind(null, null, null, t)) : isNode010 || isNode012 ? first([[ot, "close"], [t, "aborted"]], function (e, r, n) {
                                v("Request#%d %s: writeStream or res %s event emitted", A, i, n), x($ || null, null, t)
                            }) : ot.on("close", function () {
                                v("Request#%d %s: writeStream close event emitted", A, i), x($ || null, null, t)
                            }), t.pipe(ot))
                        }
                        var r = [];
                        t.on("data", function (t) {
                            v("Request#%d %s: `res data` event emit, size %d", A, i, t.length), Z += t.length, r.push(t)
                        }), t.on("end", function () {
                            var e = n.concat(r, Z);
                            ...
                            o.redirect || S(t, e, function (r, n, o) {
                                ...
                                et && v("Request#%d %s: Remote socket was terminated before `response.end()` was called", A, i), x(r, n, t)
                            })
                        })
                    }

                    function k() {
                        v("Response timer ticking, timeout: %d", st), K = setTimeout(function () {
                            K = null;
                            var t = "Response timeout for " + st + "ms";
                            $ = new Error(t), $.name = "ResponseTimeoutError", $.requestId = A, v("ResponseTimeout: Request#%d %s %s: %s, connected: %s", A, i, $.name, t, Q), j()
                        }, st)
                    }

                    function j() {
                        v("Request#%d %s abort, connected: %s", A, i, Q), ct.socket || ($.noSocket = !0, x($)), ct.abort()
                    }
                    ...
                    var I = (a.type || a.method || C.method || "GET").toUpperCase(), L = C.port || 80, P = h,
                        D = o(a.agent, r.agent), R = a.fixJSONCtlChars;
                    ...
                    var X = a.auth || C.auth;
                    X && (U.auth = X);
                    var z = a.content || a.data, G = "GET" === I || "HEAD" === I || a.dataAsQueryString;
                    ...
                    var V = null, K = null, $ = null, Q = !1, J = !1, Z = 0, tt = -1, et = !1, rt = "", nt = "",
                        it = null;
                    a.timing && (it = {
                        queuing: 0,
                        dnslookup: 0,
                    ...
                    v("Request#%d %s %s with headers %j, options.path: %s", A, I, i, U.headers, U.path), a.requestUrls.push(i);
                    var at, st;
                    Array.isArray(a.timeout) ? (at = b(a.timeout[0]), st = b(a.timeout[1])) : at = st = b(a.timeout), v("ConnectTimeout: %d, ResponseTimeout: %d", at, st);
                    var ct;
                    try {
                        ct = P.request(U, T)
                    } catch (t) {
                    ...
                    return "undefined" == typeof window ? function () {
                        v("Connect timer ticking, timeout: %d", at), V = setTimeout(function () {
                            V = null, -1 === tt && (tt = -2);
                            var t = "Connect timeout for " + at + "ms", e = "ConnectionTimeoutError";
                            ct.socket || (e = "SocketAssignTimeoutError", t += ", working sockets is full"), $ = new Error(t), $.name = e, $.requestId = A, v("ConnectTimeout: Request#%d %s %s: %s, connected: %s", A, i, $.name, t, Q), j()
                        }, at)
                        ...
                        if ("opening" === e) return t.once("lookup", function (t, e, r) {
                            v("Request#%d %s lookup: %s, %s, %s", A, i, t, e, r), it && (it.dnslookup = Date.now() - M), e && (rt = e)
                        }), void t.once("connect", function () {
                            it && (it.connected = Date.now() - M), c(), k(), v("Request#%d %s new socket connected", A, i), Q = !0, rt || (rt = t.remoteAddress), nt = t.remotePort
                        });
                        v("Request#%d %s reuse socket connected, readyState: %s", A, i, e), Q = !0, J = !0, rt || (rt = t.remoteAddress), nt = t.remotePort, c(), k()
                    }), ct.on("error", function (t) {
                        "Error" !== t.name && "TypeError" !== t.name || (t.name = Q ? "ResponseError" : "RequestError"), t.message += ' (req "error")', v("Request#%d %s `req error` event emit, %s: %s", A, i, t.name, t.message), x($ || t)
                    }), ot && ot.once("error", function (t) {
                        t.message += ' (writeStream "error")', $ = t, v("Request#%d %s `writeStream error` event emit, %s: %s", A, i, t.name, t.message), j()
                    }), a.stream ? (a.stream.pipe(ct), a.stream.once("error", function (t) {
                        t.message += ' (stream "error")', $ = t, v("Request#%d %s `readStream error` event emit, %s: %s", A, i, t.name, t.message), j()
